...
function TouchTypeRecorder({ recording, onCustomPrompt, customPrompts, stopRecording }) {
        ...
        let interval = setInterval(() => {
            if (recording) {
                ...
                if (progress === 80) {
                    ...
                    sendCustomPrompt({ newCustomPrompt: finger + ' ' + character }, onCustomPrompt);
                }
    ...
    }, [onCustomPrompt, progress, promptIndex, prompts, recording, stopRecording]);
    ...
    return (
        <div>
            ...
            <Typography variant='h4'>
                {recording ? <>
                    Press the "{prompts[promptIndex].character}" key with
                    your {prompts[promptIndex].finger} when the bar reaches the green dot
                </> : <>Waiting...</>}
            </Typography>

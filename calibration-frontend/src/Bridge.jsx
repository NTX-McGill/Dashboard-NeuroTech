...
export async function sendContinueCalibration(callback) {
	callback = callback || console.log;

	fetch("http://localhost:5000/continue-calibration")
		.then(res => callback(res))
		.catch(console.log);
}

export async function getCalibrationDone(callback) {
	fetch("http://localhost:5000/calibration-done")
		.then(res => callback(res))
		.catch(console.log);
}